...
const HEADERS = [
  ...
  'Entity',
  'Date',
  'Q1 — Most time-consuming repetitive / low-value task',
  'Q2 — Time this task takes',
  'Q3 — Applications used for daily tasks',
  'Q4 — Templated email replies',
  'Q5 — Emails requiring manual follow-up',
  'Q6 — Spreadsheets updated manually',
  'Q7 — Copy data from email/PDF?',
  'Q7b — Data copy details',
  'Q8 — Tasks that fall through cracks',
  'Q9 — One task to automate & why',
  'Ideas & Proposals',
];
